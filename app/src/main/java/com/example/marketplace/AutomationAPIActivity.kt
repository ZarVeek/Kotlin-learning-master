...
import com.example.marketplace.ui.AutomationAPIScreen
import com.example.marketplace.ui.ManualTestingScreen
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class AutomationAPIActivity : ComponentActivity() {
    ...
    private fun showErrorToast() {
        Toast.makeText(this@AutomationAPIActivity, "Ошибка запроса", Toast.LENGTH_SHORT).show()
    }
}
